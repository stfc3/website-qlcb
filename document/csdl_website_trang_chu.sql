...
(
    ...
    widget_type VARCHAR(5) COMMENT 'Loại widget',
    widget_position VARCHAR(5) COMMENT '1 Header, 2 Content, 3 Footer',
...
(
    ...
    widget_content_type VARCHAR(5) COMMENT 'Loại widget content',
    status INT DEFAULT 1 COMMENT '1: Hoạt động; 0: Không hoạt động',
    create_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
