...
public class DocumentController extends GenericForwardComposer<Component> {
    ...
    public void onDelete(ForwardEvent event) {
        ...
        Messagebox.show(Labels.getLabel("document.comfirm.delete", new String[]{document.getDocumentName()}),
...
//                    bannerService.update(banner);
                    ...
                    search();
                    Messagebox.show(
                            Labels.getLabel("document.comfirm.delete.success",
                                    new String[]{document.getDocumentName()}),
