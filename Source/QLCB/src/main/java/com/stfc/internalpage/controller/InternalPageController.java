...
public class InternalPageController extends SelectorComposer<Div> {
    ...
    public void doAfterCompose(Div comp) throws Exception {
        ...
        List<Post> lstPost = widgetService.getPost(Memory.getLstCategoryIdInternal());
...
//        lblFunctionName.setParent(spanTitleCategory);
//
//        List<Post> lstPostRelated = widgetService.getPostByCategoryId(categoryTitle.getCategoryId(), 10);
